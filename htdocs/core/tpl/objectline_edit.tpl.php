...
$.post('<?php echo DOL_URL_ROOT; ?>
	...
	', {'idprod':
<?php echo $line -> fk_product ? $line -> fk_product : 0; ?>}
, function(data) {
...
options += '<option value=null'+(trouve?'':' selected')+'><?php echo $langs -> trans("InputPrice"); ?>
	</option>';
...
alert('<?php echo $langs -> trans("rateMustBeNumeric"); ?>
	...
	{
	alert('
<?php echo $langs -> trans("markRateShouldBeLesserThan100"); ?>
	');
	e.stopPropagation();
	setTimeout(function () { rate.focus() }, 50);
	return false;
